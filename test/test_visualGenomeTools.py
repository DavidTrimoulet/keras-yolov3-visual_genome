...
class TestVisualGenomeTools(TestCase):
    ...
    def setUp(self):
        ...
        #        ]
        self.vgt = visual_genome_tools.VisualGenomeTools(p)
    ...
    def test_convert_object_yolo(self):
        self.vgt.load_visual_genome_data(filename="objects.json")
        self.vgt.generate_vg_object_vocab()
        self.vgt.clean_visual_genome_object_data()
